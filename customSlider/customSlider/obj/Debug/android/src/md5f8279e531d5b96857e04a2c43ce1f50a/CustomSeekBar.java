...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("customSlider.CustomSeekBar, customSlider, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", CustomSeekBar.class, __md_methods);
	}


	public CustomSeekBar (android.content.Context p0)
	{
		super (p0);
		if (getClass () == CustomSeekBar.class)
			mono.android.TypeManager.Activate ("customSlider.CustomSeekBar, customSlider, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}


	public CustomSeekBar (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == CustomSeekBar.class)
			mono.android.TypeManager.Activate ("customSlider.CustomSeekBar, customSlider, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:Android.Util.IAttributeSet, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0, p1 });
	}


	public CustomSeekBar (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		super (p0, p1, p2);
		if (getClass () == CustomSeekBar.class)
	...
	public CustomSeekBar (android.content.Context p0, android.util.AttributeSet p1, int p2, int p3)
	{
		super (p0, p1, p2, p3);
		if (getClass () == CustomSeekBar.class)
